...
public class LogMessage {
    ...
    public static final String AUDIT_CONTROLLER_INCOMING = "[AUDIT] Incoming call: {}.{}() with arguments: {}";
    public static final String AUDIT_CONTROLLER_COMPLETED = "[AUDIT] Completed call: {}.{}() with result: {}";
    public static final String AUDIT_CONTROLLER_EXCEPTION = "[AUDIT] Exception in: {}.{}() with error: {}";
